...
public class Regex {
    ...
    public static boolean setTextColor(TextFilds location, TextField fields) {

        if (Regex.isTextFieldValid(location, fields.getText())) {
            fields.setStyle("-fx-faint-focus-color: Green;");
            return true;
        } else {
            fields.setStyle("-fx-faint-focus-color: red;");
            return false;
        }
    }
}
